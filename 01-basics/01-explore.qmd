...
Hi Alison and Stephan,

This document summarizes current enrollment in this mock study as of `r params$date`. The three planned treatment arms are:

<--TODO: add markdown table of treatment arms here-->

We can meet to talk about next steps tomorrow- Paul
...
```{r}
mockdata <- read_csv("data/mockboston.csv")
```
